...
type SystemServiceClient interface {
	SendFile(ctx context.Context, in *SendFileReq, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SendFileResp], error)
}
...
func (c *systemServiceClient) SendFile(ctx context.Context, in *SendFileReq, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SendFileResp], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &SystemService_ServiceDesc.Streams[0], SystemService_SendFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SendFileReq, SendFileResp]{ClientStream: stream}
...
type SystemService_SendFileClient = grpc.ServerStreamingClient[SendFileResp]

// SystemServiceServer is the server API for SystemService service.
// All implementations must embed UnimplementedSystemServiceServer
// for forward compatibility.
type SystemServiceServer interface {
	SendFile(*SendFileReq, grpc.ServerStreamingServer[SendFileResp]) error
...
func (UnimplementedSystemServiceServer) SendFile(*SendFileReq, grpc.ServerStreamingServer[SendFileResp]) error {
...
func _SystemService_SendFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SystemServiceServer).SendFile(m, &grpc.GenericServerStream[SendFileReq, SendFileResp]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SystemService_SendFileServer = grpc.ServerStreamingServer[SendFileResp]
